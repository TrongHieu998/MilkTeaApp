...
public class Macchiato extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridLayoutManager gridLayoutManager= new GridLayoutManager(Macchiato.this,2);
        mRecyclerView.setLayoutManager(gridLayoutManager);
        progressDialog= new ProgressDialog(this);
        progressDialog.setMessage("Loading...");

        mFoodList= new ArrayList<>();
        myAdapter = new Adapter_Milk_Tea(Macchiato.this,mFoodList);
        mRecyclerView.setAdapter(myAdapter);
        databaseReference=FirebaseDatabase.getInstance().getReference("SanPham").child("Macchiato");
        progressDialog.show();
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent iten= new Intent(Macchiato.this, MainActivity.class);
                startActivity(iten);
                finish();
            }
        });
        ...
        imageV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent iten= new Intent(Macchiato.this, GioHang.class);
                startActivity(iten);
                finish();
            }
        });
